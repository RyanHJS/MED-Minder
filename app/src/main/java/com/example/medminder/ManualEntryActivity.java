...
public class ManualEntryActivity extends AppCompatActivity implements AdapterView.OnItemClickListener, TimePickerDialog.OnTimeSetListener,
    ...
    //labels for ListView
    public static String[] MANUAL_OPTIONS = new String[5];
    ...
    private static String t1="Date";
    private static String t2="Time";
    private static String t3="Medication Name";
    private static String t4="Medication Type";
    private static String t5="Special Notes";
...
//    public SimpleDateFormat sdf = new SimpleDateFormat("hh:mm:ss aa MMM dd yyyy");
    ...
    private static ArrayAdapter<String> manualAdapter;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        MANUAL_OPTIONS[3] = t4;
        MANUAL_OPTIONS[4] = t5;
        manualAdapter = new ArrayAdapter<>(this, R.layout.manual_list_items, MANUAL_OPTIONS);
...
//*********INTERFACE FUNCTIONS*********//
    ...
    public static void setFragmentData(int position){
        if (position==0){
            t3 = entry.getmMedicationName();
        }else  if (position==1){
            t4 = entry.getmMedicationType();
        }else  if (position==2){
            t5 = entry.getmMedicationNotes();
        }
        changeData();
    }
